package ru.ruslan.weighttracker.home.domain.usecase
...
class SaveToProfileUseCase(private val profileRepository: ProfileRepository,
    ...
    suspend fun saveWeight() {
        profileRepository.saveWeight(WeightEntity(preferencesRepository.retreiveProfileId(), 113.0, "01.01.2019"))
    }

    suspend fun savePhoto() {
        profileRepository.savePhotoData(PhotoEntity(preferencesRepository.retreiveProfileId(), "www", "01.01.2019"))
    }
