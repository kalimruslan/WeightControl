...
class SliderLayoutManager(context: Context?, scaleDown: Boolean, needListener: Boolean) : LinearLayoutManager(context){

    private var scaleDown = false
    private var needListener = true
    ...
    override fun onScrollStateChanged(state: Int) {
        ...
        if (state.equals(RecyclerView.SCROLL_STATE_IDLE)) {
            ...
            if(needListener) callback?.onItemSelected(position)
        }
    }
